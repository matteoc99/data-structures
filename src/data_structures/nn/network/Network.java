...
public class Network {
    ...
    public Network(double[] descriptor) {
        ...
        Layer layerin = new Layer(Layer.LayerType.IN);
        ...
        for (int i = 0; i < hiddenAmount; i++) {
            layerhid[i] = new Layer(Layer.LayerType.HIDDEN);
        ...
        Layer layerout = new Layer(Layer.LayerType.OUT);
...
*/
    ...
    public Network(int inputSize, int outputSize, int hiddenAmount, int[] hiddenSize) {
        ...
        Layer inLayers = new Layer(Layer.LayerType.IN);
        ...
        if (hiddenAmount > 0) {
            ...
            for (int i = 0; i < hiddenAmount; i++) {
                hiddenLayers[i] = new Layer(Layer.LayerType.HIDDEN);
        ...
        Layer outLayers = new Layer(Layer.LayerType.OUT);
    ...
    public double[] processData(double[] in) {
        ...
        if (inLayer.getType() != Layer.LayerType.IN)
